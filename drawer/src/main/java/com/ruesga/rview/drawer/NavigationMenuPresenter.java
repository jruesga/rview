...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public MenuView getMenuView(ViewGroup root) {
        if (mMenuView == null) {
            mMenuView = (NavigationMenuView) mLayoutInflater.inflate(
                    android.support.design.R.layout.design_navigation_menu, root, false);
            if (mAdapter == null) {
    ...
    private static class NormalViewHolder extends ViewHolder {
        ...
        public NormalViewHolder(LayoutInflater inflater, ViewGroup parent,
            ...
            super(inflater.inflate(com.ruesga.rview.drawer.R.layout.drawer_design_navigation_item, parent, false));
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            switch (getItemViewType(position)) {
                case VIEW_TYPE_NORMAL: {
                    ...
                    itemView.setBackground(mItemBackground != null ?
