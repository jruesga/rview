            ...
            for (ReviewerUpdateInfo ru : reviewerUpdate) {
                ...
                for (ChangeMessageInfo msg : msgs) {
                    if (msg.date.compareTo(ru.updated) > 0) {
                        ...
                        newMessage.message = ru.state.name() + ": " + ModelHelper.getAccountDisplayName(ru.reviewer);
                        newMessage.tag = "autogenerated:gerrit:reviewer_update";
                        msgs.add(i, newMessage);
                        found = true;
                        break;
                    }
                    i++;
