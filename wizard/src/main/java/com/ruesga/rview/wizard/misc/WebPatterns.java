...
/**
 * A RFC 3987 derived in android.util.Patterns, but with a relaxed TLD.
 */
public final class WebPatterns {
    ...
    // A HOST_NAME with a relaxed TLD check
    private static final String HOST_NAME = "(" + IRI_LABEL + "\\.)+" + TLD + "|" + "(" + IRI_LABEL + ")";
