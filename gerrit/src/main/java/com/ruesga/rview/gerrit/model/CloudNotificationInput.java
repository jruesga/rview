...
public class CloudNotificationInput {
    @NonNull @SerializedName("token") public String token = "";
    @SerializedName("events") public int events = 0;
    @NonNull @SerializedName("responseMode") public CloudNotificationResponseMode responseMode = CloudNotificationResponseMode.BOTH;
}
